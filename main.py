...
def draw_login_page():
    ...
    #heading label
    nsec=Label(header, text="CIET",font=("Helvetica",16,"bold"), bg = "#397ae2",fg="#1d1d54")
    nsec.place(x=0, y=10, width=400)
    username = Label(newWindow, text ="Username", font=("Helvetica", 16), relief = FLAT, bg="#f0e800")
    ...
    password = Label(newWindow, text ="Password", font=("Helvetica", 16), relief = FLAT, bg="#f0e800")
    ...
    submit= Button(newWindow, text="LOGIN", command = login, font=("Helvetica", 16), bd =2, bg = "#397ae2",fg="#1d1d54", relief=RAISED)
    submit.place(x=150, y=250, width = 100, height = 50)
    alert=Label(newWindow, text="Default Username: admin, password:admin",font=("Helvetica",8,), bg = "#397ae2",fg="#1d1d54")
...
def draw_visitor():
    ...
    option= Button(dashboard, text ="Search staff", command = draw_search_employee, bd =0, font=("Helvetica",16), bg = "#4dc7f0",fg="#1d1d54")
    option.place(x=150, y=75, width = 200, height = 50)
    option= Button(dashboard, text ="Search Student", command =  draw_search_student, bd =0, font=("Helvetica",16), bg = "#4dc7f0",fg="#1d1d54")
    option.place(x=730, y=75, width = 200, height = 50)
    option= Button(dashboard, text ="Fee Structure", command = draw_visitor_fees, bd =0, font=("Helvetica",16), bg = "#4dc7f0",fg="#1d1d54")
    option.place(x=150, y=275, width = 200, height = 50)
    option= Button(dashboard, text ="Notice Board", command = draw_notice_board,bd =0, font=("Helvetica",16), bg = "#4dc7f0",fg="#1d1d54")
    option.place(x=442, y=175, width = 200, height = 50)
    option= Button(dashboard, text ="Company List", command = draw_company_list,bd =0, font=("Helvetica",16), bg = "#4dc7f0",fg="#1d1d54")
...
def draw_admin():
    ...
    label1.photo = test
    label1.place(x=0, y=0, height = 400, width = 1080)
    option= Button(dashboard, text ="View/Edit Employee", command = draw_edit_employee, bd =0, font=("Helvetica",16), bg = "#4dc7f0",fg="#1d1d54")
    option.place(x=100, y=75, width = 250, height = 50)
    option= Button(dashboard, text ="View/Edit Student", command =  draw_edit_student, bd =0, font=("Helvetica",16), bg = "#4dc7f0",fg="#1d1d54")
    option.place(x=735, y=75, width = 250, height = 50)
    option= Button(dashboard, text ="Change Password", command = draw_change_password, bd =0, font=("Helvetica",16), bg = "#4dc7f0",fg="#1d1d54")
    option.place(x=100, y=275, width = 250, height = 50)
    option= Button(dashboard, text ="View/Edit Notice Board", command = draw_edit_notice_board, bd =0, font=("Helvetica",16), bg = "#4dc7f0",fg="#1d1d54")
    option.place(x=420, y=75, width = 250, height = 50)
    option= Button(dashboard, text ="Execute DBMS Query", command = draw_execute_dbms, bd =0, font=("Helvetica",16), bg = "#4dc7f0",fg="#1d1d54")
    option.place(x=420, y=275, width = 250, height = 50)
    option= Button(dashboard, text ="View/Edit Company List", command = draw_edit_company_list,bd =0, font=("Helvetica",16), bg = "#4dc7f0",fg="#1d1d54")
...
welcome_text = Label(frame, text = "Welcome, Visitor", font=("Minion Pro Regular", 16), bg="#f0e800")
